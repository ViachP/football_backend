...
MIDDLEWARE = [
    ...
    'corsheaders.middleware.CorsMiddleware', # Добавьте сюда
...
DATABASES = {
    'default': dj_database_url.config(
        default=os.environ.get('DATABASE_URL'),  # Автоматически возьмёт DATABASE_URL из переменных окружения Railway
        conn_max_age=600,
        ssl_require=True
    )
}
